Traditionally, software platforms for consumer electronics (e.g., Tizen, Android, and iOS) has clear target device profiles: phones, wearable devices, tablets, or TVs.
